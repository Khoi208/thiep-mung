const nameGirl = 'Phương Nhi';
const giftUrl = 'http://nodemy.vn';
const eventName = 'Chúc Mừng Sinh Nhật';
const titleCard = 'Lời Chúc';
const contentCard = 'Chúc Nhi sinh nhật luôn tràn ngập niềm vui và những nụ cười. Mong điều đẹp nhất sẽ đến với Nhi trong hôm nay và cả những ngày sau';
